...
public class DoorStatus_GW : MonoBehaviour
{
    [DllImport("libqxt")]
        ...
        while (true)
        {
            ...
            switch (doorEvent.eventcode)
            {
                case 1:
                    ...
                    if (!Mod_TextController.DoorCloseTextRunning) Mod_TextController.RunDoorCloseTextBool = true; //如果沒再跑機門關閉訊息，開始跑訊息
                    break;
                case 3:
                ...
                case 4:
                    ...
                    if (!Mod_TextController.DoorCloseTextRunning) Mod_TextController.RunDoorCloseTextBool = true;
                    break;
                case 5:
                    newSramManager.SaveCashDoorStatus(false);
